...
$data_dokumen = db_select_no_assoc(
    $koneksi,
    "SELECT 
        w.nama_warga,
        d.id_dokumen,
...
<body>
        ...
        <main class="main <?php echo !$show_welcome ? 'content-animate' : ''; ?>">
            <section class="welcome">
                ...
                <div style="display: flex; align-items: center;justify-content: center;">
                    ...
                    <button onclick="cihuy()" class="tombolprofil"><i class="fas fa-user-circle me-3"
        ...
        <div class="modal-content" style="width: 80%;">
            ...
            <table border="1" width="100%" cellpadding="8" cellspacing="0" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $data_dokumen = db_select_no_assoc($koneksi, $query_dokumen, "sii", [$sk_rt, $limit_dok, $offset_dok]);
                ...
                <div class="modal-right">
                    ...
                    <form id="pwdForm" method="POST" action="ganti_pass.php">
                        <div class="field">
                            ...
                            <input id="currentPwd" type="text" name="passwordsaatini">
                        </div>
                        <div class="field">
                            <label>Password Baru</label>
                            <input id="newPwd" type="text" name="passwordbaru">
                        </div>
                        <div class="field">
                            <label>Konfirmasi Password Baru</label>
                            <input id="confirmPwd" type="text" name="passwordtes">
                        </div>
    ...
    <script>
        ...
        function cihuy() {
            profilertcihuy.classList.add("show");
            setTimeout(() => {
                profilertcihuy.classList.add("active");
            }, 10);
        }

        function cihuytutup() {
            profilertcihuy.classList.remove("active");
            setTimeout(() => {
                profilertcihuy.classList.remove("show");
            }, 300);
        }
        ...
        btnLihatDokumen.onclick = () => {
            modalDokumen.classList.add("show");
            setTimeout(() => {
                modalDokumen.classList.add("active");
            }, 10);
        };

        closeDokumen.onclick = () => {
            modalDokumen.classList.remove("active");
            setTimeout(() => {
                modalDokumen.classList.remove("show");
            }, 300); 
        };
